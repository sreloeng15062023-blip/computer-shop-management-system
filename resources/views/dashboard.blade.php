        ...
        <aside class="w-64 bg-slate-900 text-white flex flex-col justify-between p-4 overflow-y-auto">
            <div>
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('suppliers.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('suppliers.*') ? 'bg-blue-600 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
